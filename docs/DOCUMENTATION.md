...
├── src/
│ └── severity_predictor.py # Contains SymptomSeverityPredictor class
├── app/
│ └── demo_app.py # Interactive demo app
├── tests/
│ └── test_severity.py # Unit tests for predictor
